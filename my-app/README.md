...
This project was bootstrapped with [Create React App using the TypeScript template](https://github.com/facebook/create-react-app/blob/main/docusaurus/docs/adding-typescript.md).
